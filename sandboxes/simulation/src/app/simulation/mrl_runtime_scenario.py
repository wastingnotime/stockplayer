...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_nodes=[
            ...
            ObservatoryNode("session", "Market session", "state_machine", "domain"),
            ObservatoryNode("price-history", "Price history", "event_log", "domain"),
            ObservatoryNode("orders", "Order lifecycle", "projection", "application"),
            ObservatoryNode("reservations", "Cash and owned quantity reservations", "aggregate_state", "domain"),
            ObservatoryNode("recovery", "Projection recovery", "recovery", "application"),
            ObservatoryNode("engines", "Execution engine candidates", "strategy", "domain"),
            ObservatoryNode("invariants", "Simulation invariants", "validation", "simulation"),
        ],
        observatory_edges=[
