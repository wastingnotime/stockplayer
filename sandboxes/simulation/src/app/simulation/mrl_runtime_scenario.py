...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_nodes=[
            ...
            ObservatoryNode("session", "Market session", "aggregate", "domain"),
            ObservatoryNode("price-history", "Price history", "event_store", "domain"),
            ObservatoryNode("orders", "Order lifecycle", "projection", "application"),
            ObservatoryNode("reservations", "Cash and owned quantity reservations", "aggregate", "domain"),
            ObservatoryNode("recovery", "Projection recovery", "repository", "application"),
            ObservatoryNode("engines", "Execution engine candidates", "use_case", "domain"),
            ObservatoryNode("invariants", "Simulation invariants", "event", "simulation"),
        ],
        observatory_edges=[
